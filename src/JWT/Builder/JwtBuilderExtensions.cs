...
namespace JWT.Builder
{
    public static class JwtBuilderExtensions
    {
        ...
        public static JwtBuilder Subject(this JwtBuilder builder, string subject) => builder.AddClaim(ClaimName.Subject, subject);
        ...
        public static JwtBuilder Id(this JwtBuilder builder, long id) => builder.Id(id.ToString(CultureInfo.InvariantCulture));

        public static JwtBuilder Id(this JwtBuilder builder, string id) => builder.AddClaim(ClaimName.JwtId, id);

        public static JwtBuilder GivenName(this JwtBuilder builder, string name) => builder.AddClaim(ClaimName.GivenName, name);

        public static JwtBuilder FamilyName(this JwtBuilder builder, string lastname) => builder.AddClaim(ClaimName.FamilyName, lastname);

        public static JwtBuilder MiddleName(this JwtBuilder builder, string middleName) => builder.AddClaim(ClaimName.MiddleName, middleName);
    }
}