...
namespace JWT.Algorithms
{
    ...
    public sealed class RS256Algorithm : RSAlgorithm
    {
        ...
        public RS256Algorithm(RSA publicKey, RSA privateKey) : base(publicKey, privateKey)
        {
        }
        ...
        /// </remarks>
        /// <param name="publicKey">The public key for verifying the data.</param>
        public RS256Algorithm(RSA publicKey) : base(publicKey)
        {
        }
...
#if NET35 || NET40
        protected override string HashAlgorithm => HashAlgorithmName.SHA256;
#else
