...
namespace JWT.Algorithms
{
    ...
    public sealed class RS256Algorithm : IJwtAlgorithm
    {
        ...
        {
            _publicKey = publicKey ?? throw new InvalidOperationException("Public key is null");
            _privateKey = privateKey ?? throw new InvalidOperationException("Private key is null");
        }
